...
namespace Kubinyete\Logbank\Http\Client;
...
use Kubinyete\Logbank\Exception\HttpClientException;
use Kubinyete\Logbank\Exception\HttpServerException;
use Kubinyete\Logbank\Exception\HttpTransferException;
